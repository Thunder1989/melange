...
use density as a part of weight times idscore
"""
...
modelName = "proactiveLearning_LCBUCB_LCB05_CbRate0002_density"
...
class _ProactiveLearning:
	...
	def select_example(self, unlabeled_list):
		...
		for unlabeledId in unlabeledIdScoreMap:
			unlabeledIdScoreMap[unlabeledId] = unlabeledIdScoreMap[unlabeledId]*labelDensityMap[labelIdLabelIndexMap[unlabeledId]]
