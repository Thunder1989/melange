...
modelName = "activeLearning_margin_digits"
...
class active_learning:
	...
	def select_example(self, unlabeled_list, X_train):
		...
		for unlabeledIdIndex in range(unlabeledIdNum):
			...
			labelPredictProb = self.clf.predict_proba(X_train[unlabeledId].reshape(1, -1))[0]
	...
	def run_CV(self):
		...
		for foldIndex in range(foldNum):
			...
			while queryIter < rounds:
				...
				idx = self.select_example(unlabeledExList, X_train) 
