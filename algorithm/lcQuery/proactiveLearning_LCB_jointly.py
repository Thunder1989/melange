"""
proactive learning with random initialization, judge classifier to judge whether transfer learning is correct. And incoporate CB into query strategy to see whether it is helpful 
"""
