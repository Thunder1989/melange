...
class timeseries_helper():
    ...
    def getF_1994_Li(self,X):
        ...
        # Feature
    def getF_2012_Calbimonte(self,X,B=20,segs=5):
        SS = get_SS(X,B)
    ...
    def window_feature(self,X,feature_fun,win_num,overlapping=0):
